...
setup_host_serving() {
  ...
  if [[ ! -x "$STT_VENV/bin/athome" ]]; then
    ...
    "$STT_VENV/bin/python" -m pip install 'experiment-at-home[stt,activator]==0.10.0' 'aiosqlite==0.22.1' 'annotated-types==0.7.0' 'anyio==4.14.2' 'certifi==2026.6.17' 'charset-normalizer==3.4.9' 'click==8.4.2' 'docutils==0.23' 'filelock==3.31.0' 'fsspec==2026.6.0' 'h11==0.16.0' 'hf-xet==1.5.2' 'httpcore==1.0.9' 'httpx==0.28.1' 'huggingface_hub==1.24.0' 'id==1.6.1' 'idna==3.18' 'jaraco.classes==3.4.0' 'jaraco.context==6.1.2' 'jaraco.functools==4.6.0' 'keyring==25.7.0' 'loguru==0.7.3' 'markdown-it-py==4.2.0' 'mdurl==0.1.2' 'more-itertools==11.1.0' 'nh3==0.3.6' 'packaging==26.2' 'progress==1.6.1' 'pydantic==2.13.4' 'pydantic-settings==2.14.2' 'pydantic_core==2.46.4' 'Pygments==2.20.0' 'python-dotenv==1.2.2' 'python-multipart==0.0.32' 'PyYAML==6.0.3' 'readme_renderer==45.0' 'requests==2.34.2' 'requests-toolbelt==1.0.0' 'rfc3986==2.0.0' 'rich==15.0.0' 'starlette==1.3.1' 'static_ffmpeg==3.0' 'tqdm==4.69.0' 'transcribe-cpp==0.1.3' 'transcribe-cpp-native==0.1.3' 'twine==6.2.0' 'typing-inspection==0.4.2' 'typing_extensions==4.16.0' 'urllib3==2.7.0' 'uvicorn==0.51.0'
  fi
