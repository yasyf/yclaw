...
# The real value comes from the env as PKR_VAR_vm_admin_pass, sourced from the login
# Keychain (random-generated by scripts/lib/secrets.sh, service yclaw-vm-admin-pass) —
# never prompted, never hardcoded. The @@VM_ADMIN_PASS@@ default is a fail-loud sentinel:
# build without exporting PKR_VAR_vm_admin_pass and the image bakes the placeholder. See
# docs/DEPLOY.md step 3 for the exact `PKR_VAR_vm_admin_pass=$(security ...)` invocation.
