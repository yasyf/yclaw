...
| `BLUEBUBBLES_WEBHOOK_PORT` | Port for the webhook listener. (`bluebubbles.py:43,128-131`) | int | `8645` | ✅ Default unless it collides; register `http://<vm>:8645/bluebubbles-webhook` in BlueBubbles → Settings → API → Webhooks. |
